...
var TaskInput = /** @class */ (function (_super) {
    ...
    ***************************************************************************************************************/
    TaskInput.prototype.render = function () {
        ...
        return <form onSubmit={function (event) { _this.onFormSubmit(event); }}>

                
                <input id="newTask" type="text" maxLength="50" className={this.state.inputError ? "input error" : "input"} value={this.state.inputText} onChange={function (event) { _this.onInputChange(event); }}/>
